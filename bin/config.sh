...
function config_variables()
{
    ...
    sed -i -e 's/_PROJECT_ID/'${PROJECT_ID}'/g' skaffold.yaml
...
function create_policy()
{
    ...
    sed -i -e 's/_PROJECT_ID/'${PROJECT_ID}'/g' bin/alert-policy.json
    sed -i -e 's/<_NOTIFICATION_CHANNEL_ID>/'${NOTIFICATION_CHANNEL_ID}'/g' bin/alert-policy.json
